...
#[ORM\Entity(repositoryClass: PackCatMultiRepository::class)]
class PackCatMulti
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'packCatMulti', targetEntity: Massage::class)]
    ...
    public function removeMassage(Massage $massage): self
    {
        if ($this->massages->removeElement($massage)) {
            ...
            if ($massage->getPackCatMulti() === $this) {
                $massage->setPackCatMulti(null);
            }
        }
